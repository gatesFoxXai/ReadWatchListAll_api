...
class StockDataManager:
    ...
    DEFAULT_STOCK_STRUCTURE = {
        ...
        "tier": "",
        "market": "",
        "change_type": "",  # 可為 'new', 'downgrade', 'exit_mid' 等
    }
...
# ack SubscribeWatclistAll_Out


def SubscribeWatclistAll_Out(data_manager, subscriber, start_time):
    try:
...
def main():
    """主函數"""
    data_manager, subscriber = SubscribeWatclistAllIni()
    # 記錄開始時間
    start_time = time.time()

    SubscribeWatclistAll_Out(data_manager, subscriber, start_time)
